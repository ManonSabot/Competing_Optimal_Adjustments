...
def leaf_energy_balance(p, trans, Tleaf=None):
    ...
    try:
        ...
        gc = gs * gb / (gb * conv.GwvGc + gs * conv.GbvGbc)  # mol s-1 m-2
...
def calc_photosynthesis(p, trans, Ci_s, photo, smooth=True, Tleaf=None,
                        Rleaf=None, gs_over_A=None, Vmax25=None, JV=None):
    ...
    try:  # adjust for low temperatures
    ...
    try:  # rubisco-limited photo. rate (De Pury & Farquhar, 1997)
