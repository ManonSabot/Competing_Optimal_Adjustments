...
class ConvertUnits(object):
    ...
    def __init__(self):
        ...
        self.GbvGbc = self.GwvGc ** (2. / 3.)  # Gbwater:GbCO2
...
class Constants(object):
    ...
    def __init__(self):
        ...
        self.MN = 14.0067  # molar mass of N (g mol-1)
        self.MO = 15.999  # molar mass of O (g mol-1)
        self.MRub = 0.55  # molar mass of Rubisco (g umol-1)
        self.MCO2 = self.MC + 2. * self.MO  # CO2 molar mass (g mol-1)
        self.MH2O = 2. * self.MH + self.MO  # H2O molar mass (g mol-1)
        self.NR = 11.4e-3  # N concentration of Rubisco (molN (gRub)-1)
